...
async function main() {
  ...
  // ==================================================
  // ROLES (11 records in exact database order)
  // ==================================================
